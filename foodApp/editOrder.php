...
<div
    ...
    style ="width:1000px";>
    <h1 class ="text-center text-light mb-5">Edit Order</h1>
...
if(isset($_POST['email-btn'])){
    ...
    $price = $_POST['price'];
    mysqli_query($con,"UPDATE `order_table` SET `email` = '$email', `name` = '$name',`price`='$price',`item_name`= '$item_name' WHERE `order_table`.`id` = '$edit'");
    echo '
    <div class= "container">
...
if(isset($_POST['btn-back'])){
  echo "<script> location.replace('showOrder.php'); </script>";
}
